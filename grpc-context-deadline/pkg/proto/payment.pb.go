...
const file_proto_payment_proto_rawDesc = "" +
	"\n" +
	"\x13proto/payment.proto\x12\apayment\"Z\n" +
	...
	"\bPayOrder\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponseB'Z%grpc-context-deadline/pkg/proto;protob\x06proto3"
...
var file_proto_payment_proto_depIdxs = []int32{
	0, // 0: payment.PaymentService.PayOrder:input_type -> payment.PaymentRequest
	1, // 1: payment.PaymentService.PayOrder:output_type -> payment.PaymentResponse
